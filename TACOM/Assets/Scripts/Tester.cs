...
public class Tester : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Ability a = new Ability("TestAbilityImmediate",e);
        ...
        Ability a2 = new Ability("TestAbilityRemovable",e1);
        ...
        Ability a3 = new Ability("TestAbilityTemporary",e2);
        ...
        Ability a4 = new Ability("TestAbilityPeriodic",e3);
